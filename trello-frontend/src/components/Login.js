...
const Login = () => {
  ...
  return (
    <div className="overflow-hidden h-screen">
        ...
        <div className="flex flex-col bg-[rgba(255,255,255,0.1)] rounded-3xl m-auto items-center my-16 mx-12 lg:flex lg:bg-transparent lg:m-[50px]">

            <img src={logo} alt="logo-image" className='max-w-[250px] z-10 pt-[30px] lg:max-w-[475px] lg:absolute lg:top-32 lg:left-8 xl:left-36' />
            ...
            <div className="flex flex-col items-center my-7">
                <input name='nameHolder' type="text" placeholder='Name' className='my-1.5 px-[5px] lg:p-2 bg-transparent text-[#fff] placeholder:text-[#c9c9c9] border-b-2 border-amber-300 w-[225px] placeholder:text-lg lg:placeholder:text-2xl placeholder:font-thin lg:w-[300px]' />
                <input name='idHolder' type="text" placeholder='BITS Id' className='my-1.5 lg:p-2 bg-transparent text-[#fff] placeholder:text-[#c9c9c9] border-b-2 border-red-600 w-[225px] placeholder:text-lg lg:placeholder:text-2xl placeholder:font-thin lg:w-[300px]' />
                <input type="password" name="passwordHolder" placeholder='Password' id="topsecret" className='my-1.5 lg:p-2 bg-transparent text-[#fff] placeholder:text-[#c9c9c9] border-b-2 border-cyan-400 w-[225px] placeholder:text-lg lg:placeholder:text-2xl placeholder:font-thin lg:w-[300px]'  />
