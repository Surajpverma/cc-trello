    ...
    <div className="overflow-hidden h-screen max-w-full">
        ...
        <div className="flex flex-col p-6 max-w-full max-h-full bg-[rgba(255,255,255,0.1)] rounded-3xl m-auto items-center my-16 mx-12 lg:flex lg:bg-transparent lg:m-[50px] lg:ml-[225px] lg:p-0">
            ...
            <div className=""> 
                ...
                <div className="border-b-2 w-8 lg:w-16 p-[2px] border-prmYellow"></div>
                <div className="border-b-2 w-16 lg:w-32 p-[2px] border-prmRed"></div>
                <div className="border-b-2 w-24 lg:w-48 p-[2px] border-prmBlue"></div>
            </div>
            ...
            <div className="flex flex-col items-center my-7">
                ...
                <a className="text-prmYellow font-thin text-sm lg:text-md italic self-start" href="https://symphonious-malasada-9bd768.netlify.app/">forgot password ??</a> {/*isko link krna h ya nhi? ye jaruri bhi h ya nhi */}
            </div>
